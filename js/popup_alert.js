               ...
               */         
                markup +='<div class="content-body">' + this.message + '</div>'+
                         '<footer style="clear:both;">'+
                             ...
                             //'<input type="submit" value="' + this.ok + '" href="javascript:;" class="car-popup-ok ' + this.okClass + '"  ></input>'+
                '<button type="submit" href="javascript:;" class="car-popup-ok ' + this.okClass + '"  >'+this.ok+'</button>'+
                        ' </footer>'+
                     '</div></div>';
